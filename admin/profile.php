...
if (isset($_POST['edit_profile'])) {
    ...
    $id = $_SESSION['u_id'];// get id from url
    ...
    if (!isset($errorMsg)) {
        try {
            $update_user = $db->prepare("UPDATE user SET username=:uusername, user_password=:upassword,
    user_firstname=:ufirstname, user_lastname=:ulastname, user_email=:uemail, user_image=:uimage WHERE
    user_id=:userid");
                    ...
                    <form action="" method="Post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInput"
                                value="<?php echo $user_firstname ?>" name="txt_firstname" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="exampleInput"
                                value="<?php echo $user_lastname ?>" name="txt_lastname" required>
                        </div>
                        <!-- username -->
                        <div class="form-group">
                            <label for="status">Username</label>
                            <input type="text" class="form-control" id="exampleInput" value="<?php echo $username ?>"
                                name="txt_username" required>
                        </div>
                        ...
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                <input type="file" class="form-control" value="<?php echo $user_image ?>"
                                    id="exampleInput" name="txt_file">
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" class="form-control" id="exampleInput"
                                placeholder="Enter Your old Password" name="txt_old_password" required>
                        </div>
                        <!-- password -->
                        <div class="form-group">
                            <label for="tag">New Password</label>
                            <input type="password" class="form-control" id="exampleInput"
                                placeholder="Enter Your New Password" name="txt_password">
                        </div>
                        <!-- comfirm password -->
                        <div class="form-group">
                            <label for="tag">New Comfirm Password</label>
                            <input type="password" class="form-control" id="exampleInput"
                                placeholder="Comfirm Your New Password" name="txt_comfirm_password">
                        </div>
                        <!-- Post Content -->
                        <div class="form-group">
                            <label for="content">Email</label>
                            <input type="email" class="form-control" id="exampleInput" value="<?php echo $user_email ?>"
